...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.analysi.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.analysis.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="naissance">{{ trans('cruds.analysi.fields.naissance') }}</label>
                <input class="form-control {{ $errors->has('naissance') ? 'is-invalid' : '' }}" type="text" name="naissance" id="naissance" value="{{ old('naissance', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('heure_prelev') ? 'is-invalid' : '' }}" type="text" name="heure_prelev" id="heure_prelev" value="{{ old('heure_prelev', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('date_prelev') ? 'is-invalid' : '' }}" type="text" name="date_prelev" id="date_prelev" value="{{ old('date_prelev', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('identification') ? 'is-invalid' : '' }}" type="text" name="identification" id="identification" value="{{ old('identification', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ct') ? 'is-invalid' : '' }}" type="text" name="ct" id="ct" value="{{ old('ct', '') }}" required>
                @if($errors->has('ct'))
                    <div class="invalid-feedback">
                        {{ $errors->first('ct') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('resultat') ? 'is-invalid' : '' }}" type="text" name="resultat" id="resultat" value="{{ old('resultat', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('conclusion') ? 'is-invalid' : '' }}" type="text" name="conclusion" id="conclusion" value="{{ old('conclusion', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('origine_prelev') ? 'is-invalid' : '' }}" type="text" name="origine_prelev" id="origine_prelev" value="{{ old('origine_prelev', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('date_rendu') ? 'is-invalid' : '' }}" type="text" name="date_rendu" id="date_rendu" value="{{ old('date_rendu', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type_cas') ? 'is-invalid' : '' }}" type="text" name="type_cas" id="type_cas" value="{{ old('type_cas', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('code_interne') ? 'is-invalid' : '' }}" type="text" name="code_interne" id="code_interne" value="{{ old('code_interne', '') }}" required>
